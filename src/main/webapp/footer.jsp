<footer class="bg-dark text-white py-4 mt-5 border-top">
	<div
		...
		<p class="mb-3 mb-md-0 col-md-4 text-center text-md-start">© 2025
			GameLet, Inc. Todos os direitos reservados.</p>
		...
		<ul class="nav col-md-4 justify-content-center justify-content-md-end">
			...
			<li class="nav-item"><a href="SobreSistema.jsp"
				class="nav-link px-2 text-white">Sobre</a></li>
		</ul>
