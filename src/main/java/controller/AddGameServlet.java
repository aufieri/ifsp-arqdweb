	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (titulo == null || titulo.isEmpty() || dev == null || dev.isEmpty() || ano == null || ano.isEmpty()
					|| genero == null || genero.isEmpty() || sinopse == null || sinopse.isEmpty() || idioma == null
					|| idioma.isEmpty() || plataforma == null || plataforma.isEmpty() || classificacao == null
					|| classificacao.isEmpty() || aval == null || aval.isEmpty() || precoStr == null
					|| precoStr.isEmpty() || nomeImagem.isEmpty()) { // Se imagem for obrigatória
			...
			Jogo novoJogo = new Jogo(titulo, dev, anoLancamento, genero, sinopse, idioma, plataforma, classificacao,
					avaliacao, nomeImagem, preco, destaque, lancamento);
