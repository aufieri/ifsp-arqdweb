...
<form id="Cadastro">
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputJogo" aria-describedby="jogoHelp">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputGenero" aria-describedby="GenerolHelp">
  </div>
...
<div class="mb-3">
  <label for="formFileSm" class="form-label">Adicione uma Imagem Referente ao Jogo</label>
